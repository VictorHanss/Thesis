...
data1 = np.genfromtxt('LV_exp-588_filtered-2_profile.csv', delimiter=',', skip_header=1)  # Replace 'dataset1.csv' with the actual path to your first CSV file

# Load median filtered dataset
data2 = np.genfromtxt('LV_exp-588_filtered-2_profile_median30.csv', delimiter=',', skip_header=1)  # Replace 'dataset2.csv' with the actual path to your second CSV file
...
plt.axhline(y=40, color='green', linestyle='dotted', linewidth=1.5, label='Image Mean')
...
plt.title('Profile of silver enhanced cell electroporated with L.V. protocol')
...
plt.savefig('LV_plot.png',transparent=True, dpi=150)
